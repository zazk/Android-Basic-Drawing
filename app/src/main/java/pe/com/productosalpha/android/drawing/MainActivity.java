...
public class MainActivity extends AppCompatActivity implements OnClickListener{
    ...
    public void patternClicked(View view) {
        ...
        if (view != currPaint) {
            ...
            //set patten to brush
            drawView.setPattern(view.getTag().toString());
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast yesToast = Toast.makeText(getApplicationContext(),
                            "We have permission to save a image in the Gallery!", Toast.LENGTH_SHORT);
                    yesToast.show();
                    ...
                    Toast yesToast = Toast.makeText(getApplicationContext(),
                            "Can't save in the Gallery!", Toast.LENGTH_SHORT);
                    yesToast.show();
                }
                return;
            }
